...
def add_server_to_yaml(filename):
    try:
        with open(filename, 'a') as file:
            ...
            file.write("    volumes:\n")
            file.write("      - /home/markus/Documents/disribuidos/tp0-distribuidos/server/config.ini\n")
...
def add_client_to_yaml(filename, client_number):
    try:
        with open(filename, 'a') as file:
            ...
            file.write("    volumes:\n")
            file.write("      - /home/markus/Documents/disribuidos/tp0-distribuidos/client/config.yaml\n")
            file.write("    environment:\n")
